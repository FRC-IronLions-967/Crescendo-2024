 ...
 */
public class CustomPOVButton extends CustomTrigger {
  /**
   ...
   */
  public CustomPOVButton(GenericHID joystick, int angle, int povNumber) {
   ...
   */
  public CustomPOVButton(GenericHID joystick, int angle) {
