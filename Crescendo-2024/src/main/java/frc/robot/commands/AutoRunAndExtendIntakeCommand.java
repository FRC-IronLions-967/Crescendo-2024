...
public class AutoRunAndExtendIntakeCommand extends Command {
  /** Creates a new RunAndExtendIntake. */
  private Timer timer;
  private double kIntakeMinPosition;
  public AutoRunAndExtendIntakeCommand() {
  ...
  public boolean isFinished() {
    ...
    return SubsystemsInstance.getInstance().intakesubsystem.isNoteIn() || timer.hasElapsed(5.0);
